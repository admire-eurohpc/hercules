...
class Hercules(CMakePackage):
    ...
    depends_on('pcre')
    depends_on('jemalloc')
    depends_on('ucx@=1.14.0 mlx5_dv=True openmp=True verbs=True dm=True rc=True thread_multiple=True ucg=True xpmem=False dc=True rdmacm=True knem=True cma=True ib_hw_tm=True rocm=False ud=True')
