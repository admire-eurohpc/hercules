...
#SBATCH --output=logs/lustre/%j_hercules.log   # Standard output and error log
#SBATCH --mem=0
#SBATCH --overcommit
...
COMMAND="$IOR_PATH/ior -t ${TRANSFER_SIZE}kb -b ${FILE_SIZE_PER_CLIENT}kb -s 1 -i 5 -F -o /lustre/scratch/javier.garciablas/ior_output/data.txt"
