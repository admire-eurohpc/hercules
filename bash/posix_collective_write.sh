...
if [ "$#" -ne 2 ]
   ...
   then
	...
	echo -e "\nNOT ENOUGH ARGUMENTS!\n\nUSAGE:\n\n\t./posix_collective_write.sh <TETS_FILE_PATH> <CSV_FILE_PATH>\n\n"
...
if [ ! -e $test_file ]
   ...
   then
	...
	for dataset_size in 262144 1048576 4194304 
	   do
		...
		for block_size in 4 16 64 256 1024 4096 16384 65536
		   do
			...
			for it in {0..9}
			   do
				../build/posix_collective_write $dataset_size $block_size $file_path >> $test_file
